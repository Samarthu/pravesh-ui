...
<script>
    ...
    var driving_license_pattern =
        /^(([A-Z]{2}[0-9]{2})( )|([A-Z]{2}-[0-9]{2})|([A-Z]{2}[0-9]{2}))((19|20)[0-9][0-9])[0-9]{7}$/;
        ...
        if ($facility_id.facility_id_number) {
            ...
            for (
                ...
                if (
                    ...
                    pan_card_data.doc_number =
                        $duplicate_documents_store.documents[i].doc_number;
                    console.log("edit_pan_card_data", edit_pan_card_data);
                } else if (
                    $duplicate_documents_store.documents[i].doc_category ==
                    "Aadhar Id proof"
                ) {
                    edit_adhar_card_data =
                        $duplicate_documents_store.documents[i];
            ...
            for (let i = 0; i < $documents_store.documents.length; i++) {
                if ($documents_store.documents[i].doc_category == "Pancard") {
                    ...
                    pan_card_data.doc_number =
                        $documents_store.documents[i].doc_number;
                    ...
                    if ($facility_id.facility_id_number) {
                        if (
                            ...
                            if (pan_card_proof_response.body.data == false) {
                                show_spinner = false;
                                pan_card_message =
                                    pan_card_proof_response.body.message;
                            } else {
                                show_spinner = false;
                                pan_card_message = "";
                                pan_check = true;
            ...
            if (!adhar_card_data.doc_number.match(adhar_crad_pattern)) {
                ...
                try {
                    ...
                    if ($facility_id.facility_id_number) {
                        if (
                            adhar_card_data.doc_number !=
                            edit_adhar_card_data.doc_number
                        ) {
                            if (adhar_card_proof_response.body.data == false) {
                                show_spinner = false;
                                console.log(
                                    "inside if adhar_card_proof_response"
                                );
                                adhar_card_message =
        ...
        if (voter_id_card_data.doc_number) {
            ...
            if (!voter_id_card_data.doc_number.match(voter_id_pattern)) {
                ...
                try {
                    ...
                    if ($facility_id.facility_id_number) {
                        if (
                            edit_voter_id_card_data.doc_number !=
                            voter_id_card_data.doc_number
                        ) {
                            if (voter_id_proof_response.body.data == false) {
                                show_spinner = false;
                                voter_id_message =
                                    voter_id_proof_response.body.message;
                            } else {
                                show_spinner = false;
                                voter_id_message = "";
                                voter_id_check = true;
                ...
                try {
                    ...
                    if ($facility_id.facility_id_number) {
                        if (
                            ...
                            if (
                                driving_license_proof_response.body.data ==
                                false
                            ) {
                                show_spinner = false;
                                driving_license_message =
    ...
    const on_pan_upload = (e) => {
        ...
        if (image.size <= allowed_pdf_size) {
            if (pan_card_data.doc_number != null) {
                ...
                pan_card_message = "Please Enter Pan Card Number";
            }
        } else {
            alert(
    ...
    const on_adhar_upload = (e) => {
        ...
        if (image.size <= allowed_pdf_size) {
            if (adhar_card_data.doc_number != null) {
                ...
                adhar_card_message = "Please Enter Adhar Card Number";
            }
        } else {
            alert(
                "File size is greater than " +
    ...
    const on_voter_id_upload = (e) => {
        ...
        if (image.size <= allowed_pdf_size) {
            if (voter_id_card_data.doc_number != null) {
                ...
                voter_id_message = "Please Enter Voter Id Card Number";
            }
        } else {
            alert(
                "File size is greater than " +
    ...
    const on_driving_license_upload = (e) => {
        ...
        if (image.size <= allowed_pdf_size) {
            if (driving_license_data.doc_number != null) {
                ...
                driving_license_message = "Please Enter Driving License Number";
            }
        } else {
            alert(
                "File size is greater than " +
    ...
    function check_validity() {
        ...
        if ($facility_id.facility_id_number) {
            ...
            if (adhar_card_data.pod || adhar_card_data.doc_number) {
                adhar_card_data.status = "active";
                adhar_card_data.resource_id = $facility_id.facility_id_number;
                adhar_card_data.user_id = $current_user.username;
                if (
                    adhar_card_data.doc_number !=
                    edit_adhar_card_data.doc_number
                ) {
            ...
            if (voter_id_card_data.doc_number || voter_id_card_data.pod) {
                voter_id_card_data.resource_id =
                    $facility_id.facility_id_number;
                voter_id_card_data.status = "active";
                voter_id_card_data.user_id = $current_user.username;
                if (
                    voter_id_card_data.doc_number !=
                    edit_voter_id_card_data.doc_number
                ) {
            ...
            if (driving_license_data.doc_number || driving_license_data.pod) {
                ...
                if (
                    driving_license_data.doc_number !=
                    edit_driving_license_data.doc_number
                ) {
                    for (
                        let i = 0;
                        i < $documents_store.documents.length;
                ...
                <!-- <li class="tabactivelink">
                    <a href="#" class="tabAchorSection ">
                        ...
                        <div class="contentTitles">
                            ...
                            <p class="contentDescriptionText ">
        ...
        <div class="w-widthforFormSection w100xs ">
            <div class="onboardForm ">
                <div class="formTextSection">
                    <p class="smxslabel">Identity Proof</p>
                    <p class="formHeadingLabel ">
                        Submit associate identity proof details
                    </p>
                ...
                <form action="#">
                    <div class="formElements">
                                            ...
                                            <div class="flex">
                                                <a
                                                    href={$page.url.origin +
                                                        edit_pan_card_data.file_url}
                                                    target="_blank"
                                                    class="text-blue-600 text-decoration-line: underline"
                                                    >{edit_pan_card_data.file_name}</a
                                                >
                                                <br />
                                            </div>
                                        {/if}
                            ...
                            <div class="formGroup ">
                                ...
                                <div class="formInnerGroup ">
                                    ...
                                    <input
                                        type="text"
                                        class="inputbox"
                                        bind:value={adhar_card_data.doc_number}
                                        on:blur={() => verify_adhar_card()}
                                    />
                                    <!-- <div class="text-red-500">
                                {adhar_card_message}
                            </div> -->
                                    ...
                                    {#if $facility_id.facility_id_number}
                                        {#if edit_adhar_card_data.file_name}
                                            <div class="flex">
                                                <a
                                                    href={$page.url.origin +
                                                        edit_adhar_card_data.file_url}
                                                    target="_blank"
                                                    class="text-blue-600 text-decoration-line: underline"
                                                    >{edit_adhar_card_data.file_name}</a
                                                >
                                                <br />
                                            </div>
                                        {/if}
                            ...
                            <div class="formGroup ">
                                ...
                                <div class="formInnerGroup ">
                                    ...
                                    <input
                                        type="text"
                                        class="inputbox"
                                        bind:value={voter_id_card_data.doc_number}
                                        on:blur={() => verify_voter_id_card()}
                                    />
                                    <!-- <div class="text-red-500">
                                {voter_id_message}
                            </div> -->
                                    ...
                                    {#if $facility_id.facility_id_number}
                                        {#if edit_voter_id_card_data.file_name}
                                            <div class="flex">
                                                <a
                                                    href={$page.url.origin +
                                                        edit_voter_id_card_data.file_url}
                                                    target="_blank"
                                                    class="text-blue-600 text-decoration-line: underline"
                                                    >{edit_voter_id_card_data.file_name}</a
                                                >
                                                <br />
                                            </div>
                                        {/if}
                            ...
                            <div class="formGroup ">
                                ...
                                <div class="formInnerGroup ">
                                    ...
                                    <input
                                        type="text"
                                        class="inputbox"
                                        bind:value={driving_license_data.doc_number}
                                        on:blur={() => verify_driving_license()}
                                    />
                                    <!-- <div class="text-red-500">
                                {driving_license_message}
                            </div> -->
                                    ...
                                    {#if $facility_id.facility_id_number}
                                        {#if edit_driving_license_data.file_name}
                                            <div class="flex">
                                                <a
                                                    href={$page.url.origin +
                                                        edit_driving_license_data.file_url}
                                                    target="_blank"
                                                    class="text-blue-600 text-decoration-line: underline"
                                                    >{edit_driving_license_data.file_name}</a
                                                >
                                                <br />
                                            </div>
                                        {/if}
                        ...
                        <!-- <button
                            ...
                            class="saveandproceed">Temp</button
                        >
                        <button
                            on:click|preventDefault={() => {
                                temp_value_filled();
            ...
            <div class="onboardFormNot ">
                <div class="formFooterAction">
                    ...
                    <button
                        ...
                        class="saveandproceed">Save</button
                    >
                    <button
                        on:click={() => {
                            on_proceed();
