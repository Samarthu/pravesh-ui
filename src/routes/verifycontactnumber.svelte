    ...
    <div class="onboardForm ">
        ...
        <form action="#">
            <div class="formElements">
                <div class="flex">
                    <div class="formGroup ">
                        <label class="formLable ">Associate Mobile Number <span
    ...
    <div class="onboardForm ">
        ...
        <form action="#">
            <div class="formElements">
                <div class="flex">
                    <div class="formGroup ">
                        <label class="formLable ">Enter OTP code <span
                                class="mandatoryIcon">*</span></label>
                        <div class="formInnerGroup ">
                            <span class="searchicon">
                                <img src="{$img_url_name.img_name}/mobilephone.png" class="placeholderIcon" alt="">
...
<!-- <div id="toast-success" class="toast-success-msg" role="alert">
    ...
    <div class="toastSuccessText">Item moved successfully. </div>
    <button type="button" class="toastCloseButton" data-dismiss-target="#toast-success" aria-label="Close">
...
<!-- <div id="toast-danger" class="toast-danger-msg" role="alert">
    ...
    <div class="toastDangerText">Item moved successfully. </div>
    <button type="button" class="toastCloseButton" data-dismiss-target="#toast-success" aria-label="Close">
        <span class="sr-only">Close</span>
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
    </button>
...
<!-- <div id="toast-warning" class="toast-warning-msg" role="alert">
    ...
    <div class="toastWarningText">Item moved successfully. </div>
    <button type="button" class="toastCloseButton" data-dismiss-target="#toast-success" aria-label="Close">
        <span class="sr-only">Close</span>
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
    </button>
