<script>
    ...
    let file_data;
    let showbtn = 0;
    let facility_address,facility_postal,facility_password,city,new_fac_remarks,status_name;
...
/////////bank details//////;///////
    ...
    async function cheque_button_click() {
        ...
        console.log("cheque Date", cheque_date);
        console.log("bank_name", bank_name);
        if (bank_name == "" || bank_name == "undefined") {
            console.log("Please Enter Bank Name");
        } else {
            ...
            // console.log("cheque_details_form", cheque_details_form);
